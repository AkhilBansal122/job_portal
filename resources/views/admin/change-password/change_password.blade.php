...
@push('style')
	...
	<style>
		/ Custom Toastr Styles / #toast-container>div {
			background-color: brown;
			/ Dark background color / color: #fff;
			/ Light text color / box-shadow: none;
			/ Remove shadow / border: none;
		}

		#toast-container>div.toast-success {
			background-color: green;
			/ Success messages background color / background-color: green;
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<input name="new_password_confirmation" type="password" class="form-control"
								id="confirmNewPasswordInput" placeholder="Confirm New Password"><i
