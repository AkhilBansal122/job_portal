	...
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
			<div class="page-header">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 text-right">
						<div class="dropdown">
							<a class="btn btn-primary " href="{{route('job-categories.create')}}" role="button"
								no-arrow>
								Add Job Category
							</a>
						</div>
			...
			<div class="card-box mb-30">
				...
				<div class="pb-20">
					<table id="jobCategoryDatatable" class="data-table1 table stripe hover nowrap">
						<thead>
							<tr>
...
@push('script')
	...
	<script type="text/javascript">
		$(function () {
			...
			// 	alert(id);
			// });
			var table = $('#jobCategoryDatatable').DataTable({
				processing: true,
				serverSide: true,
				...
				ajax: {
					url: "{{ route('jobCategoryAjax') }}",
					type: "POST",
					data: {
						from_date: $('input[name=from_date]').val(),
						end_date: $('input[name=end_date]').val(),
						status: $('select[name=status]').val(),
						search: $('input[name=job_category_name]').val(),
			...
			// for chnage status
			$(document).on('click', '.selectJobCategory', function () {
				...
				$.ajax({
					type: "POST",
					url: @json(route('changeJobCategoryStatus')),
