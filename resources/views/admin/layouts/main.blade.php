...
<div class="main-container">
	<div class="xs-pd-20-10 pd-ltr-20">
		<div class="title pb-20">
			<h2 class="h3 mb-0">Job Overview</h2>
		</div>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">
									<a href="{{route('users.index')}}">Total User</a>
								</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#00eccf">
									<i class="icon-copy fi-torsos"></i>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="d-flex flex-wrap">
							...
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b">
									<span class="icon-copy fi-torsos"></span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500"><a
										href="{{route('services.index')}}">Total
										Service</a></div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06">
									<i class="icon-copy fa ti-support" aria-hidden="true"></i>
								</div>
							</div>
						</div>
					</div>
			...
			<a href="{{route('jobrequest.index')}}">
				<div class="col-xl-4 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark">{{$totalPendingJobRequest}}</div>
								<div class="font-14 text-secondary weight-500"><a
										href="{{route('jobrequest.index')}}">Total
										Pending Job Request</a></div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06">
									<i class="icon-copy fa ti-support" aria-hidden="true"></i>
