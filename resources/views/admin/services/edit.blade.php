    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{$services ? 'Edit Service' : 'Add Service'}}
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="{{ $services ? route('services.update', $services->id) : route('services.update') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="job_id">
                                    ...
                                    @foreach ($getJob as $value)
                                        <option value="{{ $value->id }}" {{ $value->id == $services->job_id ? 'selected' : '' }}>{{ $value->job_name }}</option>
                                    @endforeach
                                </select>
