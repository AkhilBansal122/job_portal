													...
													<ul>
														<li>
															...
															<div class="task-name"><i
																	class="ion-android-alarm-clock"></i> Task Added
															</div>
													...
													<ul>
														...
														<li>
															<div class="custom-control custom-checkbox mb-5">
																...
																elit. Unde hic non repellendus debitis iure, doloremque
																assumenda. Autem modi, corrupti, nobis ea iure fugiat,
																veniam non quaerat mollitia animi error corporis. <div
																	class="task-type">Email</div>
																Lorem ipsum dolor sit amet.
																<div class="task-assign">Assigned to Ferdinand M. <div
																		class="due-date">due date <span>22 February
																			2018</span></div>
																	...
																	<ul>
																		<li>
																			<form>
																				...
																				adipisicing elit. Unde hic non
																				repellendus debitis iure, doloremque
																				assumenda. Autem modi, corrupti, nobis
																				ea iure fugiat, veniam non quaerat
																				mollitia animi error corporis. <label
																					class="col-md-4">Task Type</label>
																				<div class="col-md-8">
																					<input type="text"
																						class="form-control">
																				</div>
